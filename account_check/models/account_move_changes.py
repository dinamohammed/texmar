...
class AccountMoveLineInherit(models.Model):
    ...
    def _create_writeoff(self, writeoff_vals):
        ...
        TODO:: Add name of reconsilation line to use as ref to be viewed on invoice payments info
        """
        ref = writeoff_vals[0].get('name')
        ...
        for journal_id, lines in writeoff_dict.items():
            ...
            writeoff_move = self.env['account.move'].create(writeoff_move_vals)
